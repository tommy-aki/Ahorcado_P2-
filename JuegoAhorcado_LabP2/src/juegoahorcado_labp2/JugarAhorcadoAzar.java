 ...
 */
public class JugarAhorcadoAzar extends JuegoAhorcadoBase{
    private String memoria;
    
    public JugarAhorcadoAzar(){
        palabraActual="";
        palabraSecreta=inicializarPalabraSecreta();
    ...
    public String inicializarPalabraSecreta() {
        return AdminPalabrasAzar.ranWord();
    }
